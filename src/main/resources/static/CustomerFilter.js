...
function search() {
   ...
   // console.log("data " + data.get("lookupTypes"));
    ...
    {data.set("classname","");}
    console.log("classname "+data.get("classname"));
    if(data.get("active")==null)
    { data.set("active","");}
    console.log("active "+data.get("active"));
    //console.log(data.get("ParentLookup"));
    xhr.open("post", "/SearchCustomer");      // open connection
...
function deleteRows() {
    ...
    //console.log("result[d+3]"+result[d+3]);
    console.log("result[(d*4)+3]"+result[(d*4)+3]);
    xhttp.open("GET", "/DeleteCustomer?id="+result[(d*4)+3]);
    ...
    xhttp.onload=function()
    {
        if(xhttp.responseText.split(",")[0]==1)
        {
            ...
            console.log(result[d*4]); console.log(result[(d*4)+3]);
            result.splice(d*4,(d*4)+3);
            //result.splice(d,d+3);
...
function EditRows() {
    ...
    console.log("result[(d*4)+3]"+result[(d*4)+3]);
    xhr.open("GET", "/UpdateCustomer?id="+result[(d*4)+3]);
    xhr.send();
    xhr.onload=function()
    {
        editflag=1;
